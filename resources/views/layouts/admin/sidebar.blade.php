<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
      ...
      <h1 class="navbar-brand navbar-brand-autodark">
        <a href="." >
          <img src="{{ asset('assets/img/logo_presensi.png') }}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
          <span>HRMS</span>
        </a>
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
            ...
            <div class="dropdown-menu {{ request()->is(['karyawan', 'departemen']) ? 'show' : ''}} ">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  ...
                  <a class="dropdown-item {{ request()->is(['kantorcabang']) ? 'active' : ''}}" href="/kantorcabang">
                    Data Kantor Cabang
                  </a>
                </div>
              </div>
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->is(['presensi/approvalizin']) ? 'active' : ''}}" href="/presensi/approvalizin" >
              <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
          ...
          <li class="nav-item dropdown">
            ...
            aria-expanded="{{ request()->is(['presensi/laporanpresensi', 'presensi/rekappresensi']) ? 'true' : 'false'}}" >
              <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
            ...
            <div class="dropdown-menu {{ request()->is(['presensi/laporanpresensi', 'presensi/rekappresensi']) ? 'show' : ''}}">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a class="dropdown-item {{ request()->is(['presensi/laporanpresensi']) ? 'active' : ''}}" href="/presensi/laporanpresensi">
                    Laporan Presensi
                  </a>
                  <a class="dropdown-item {{ request()->is(['presensi/rekappresensi']) ? 'active' : ''}}" href="/presensi/rekappresensi">
                    Rekap Presensi
                  </a>
                </div>
              </div>
          ...
          <li class="nav-item dropdown {{ request()->is(['konfigurasi','konfigurasi/*' ]) ? 'show' : ''}}">
            ...
            role="button" aria-expanded="{{ request()->is(['konfigurasi','konfigurasi/*']) ? 'true' : 'false'}}" >
              <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
