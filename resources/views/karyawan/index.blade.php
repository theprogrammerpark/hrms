                                ...
                                <div class="row"">
                                    <div class="col-4">
                                        <div class="form-group">
                                            <input type="text" name="nama_karyawan" class="form-control" value="{{ Request('nama_karyawan') }}" placeholder="Nama Karyawan">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <form action="">
                                                    <a href="#" class="btn btn-success btn-sm edit" nik={{ $d->nik }}>
                                                ...
                                                <form action="" style="margin-left:5px">
                                                    <a href="/konfigurasi/{{ $d->nik }}/setjamkerja" class="btn btn-warning btn-sm">
...
<div class="modal modal-blur fade" id="modal-input-karyawan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/karyawan/store" id="frmkaryawan" name="frmkaryawan" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="" id="nama_langkap" name="nama_langkap" class="form-control" placeholder="Nama Lengkap">
                          </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="" id="nohp" name="nohp" class="form-control" placeholder="No HP">
                          </div>
                    </div>
                </div>
                <div class="row">
  ...
  {{-- Modal Edit --}}
  <div class="modal modal-blur fade" id="modal-edit-karyawan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
...
<script>
    $(function () {
        ...
        $("#frmkaryawan").submit(function () {
            var nik = $("#nik").val();
            var nama_lengkap = $("#nama_langkap").val();
